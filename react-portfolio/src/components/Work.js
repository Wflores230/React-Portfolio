...
const Work = () => {
    ...
    const openPopupboxStarwars = () => {
        ...
        const content = (
            ...
            <p className="popup-box-font">This was my first group project. In our group Star Wars is the most profound, epic, cinematic movie series of our time. This fact is exactly what inspired our team to create this project. It is a character quiz! The way we achieved this is providing an introductory statement and you are allowed to select an opion between Strongly Agree, Disgree, and Neutral.</p>
            <b className="popup-box-font">Demo:</b> <a className="hyper-link" onClick={() => window.open("https://wflores230.github.io/Star-Wars-Quiz/")}>https://wflores230.github.io/Star-Wars-Quiz/</a>
            <br></br>
            <b className="popup-box-font">Github:</b> <a className="hyper-link" onClick={() => window.open("https://github.com/Wflores230/Star-Wars-Quiz")}>https://github.com/Wflores230/Star-Wars-Quiz</a>
            </>
        )
    ...
    const openPopupboxBudgetTracker = () => {
        ...
        const content = (
            ...
            <p className="popup-box-font">This is a Budget Tracker application to allow for offline access and functionality. The user will be able to add expenses and deposits to their budget with or without a connection. When entering transactions offline, they should populate the total when brought back online. This app should give users a fast and easy way to track their money.</p>
            <b className="popup-box-font">Demo:</b> <a className="hyper-link" onClick={() => window.open("https://sleepy-thicket-46451.herokuapp.com/")}>https://sleepy-thicket-46451.herokuapp.com/</a>
            <br></br>
            <b className="popup-box-font">Github:</b> <a className="hyper-link" onClick={() => window.open("https://github.com/Wflores230/Budget-Tracker.git")}>https://github.com/Wflores230/Budget-Tracker.git</a>
            </>
        )
        PopupboxManager.open({content})
        PopupboxManager.update({  content, config: {
